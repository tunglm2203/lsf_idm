...
def plot_multiple_results(directories):
    ...
    legend_name = ["SAC", "SAC+avg.", "SAC+ours"]
    ...
    plot_xlabels = dict(
        ...
        manipulation=r'Environment steps ($\times 1e6$)'
    )
    ...
    env_lims = dict(
        cartpole_swingup=[[0, 1000000], [1, 950]],
        ball_in_cup_catch=[[0, 500000], [1, 950]],
        cheetah_run=[[0, 700000], [1, 600]],
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(args.save_path, 'compare_{}.pdf'.format(args.env)))
    plt.show()
...
if __name__ == '__main__':
    ...
    experiments = dict(
        cartpole_swingup=[
            ...
            'logs/cartpole-swingup/lsf_previous_method/',
        ...
        ball_in_cup_catch=[
            ...
            's159_logs/ball_in_cup-catch/lsf_previous_method/',
        ...
        cheetah_run=[
            ...
            'logs/cheetah-run/lsf_previous_method/',
        ...
        manipulation=[
            's159_logs/manipulation-reach_duplo/sac_rad/',
            's159_logs/manipulation-reach_duplo/lsf_previous_method',
            's159_logs/manipulation-reach_duplo/sac_lsf_rad_1000init_1gs_aclr1e-4_clr1e-4_allr1e-4_elr1e-4_ac_freq2_2_enccri_tau0.01_0.01_declr1e-4_bs128_baseline_extra_upd_critic_uselsf_1_extraupd_1_n_invupd_1_aug_1_alpha0.9/'
        ]
    )
    env_ranges = dict(
