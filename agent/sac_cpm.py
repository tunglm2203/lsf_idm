...
class CURL(nn.Module):
    ...
    def __init__(self, obs_shape, action_shape, z_dim, critic, critic_target,
...
class SacCPMAgent(object):
    ...
    def update_fdm(self, cur_obs_anchor, next_obs_pos, cur_action, L, step):
