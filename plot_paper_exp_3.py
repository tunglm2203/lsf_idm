...
def plot_multiple_results(directories):
    ...
    color_table = ['#1ac938', '#e8000b', '#023eff', '#1ac938', '#e8000b', '#023eff']
    linestyle = ['-', '-', '-', '--', '--', '--']
    ...
    env_lims = dict(
        cartpole_swingup=[[0, 500000], [1, 850]],
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(args.save_path, 'ab_2_{}.pdf'.format(args.env)))
    plt.show()
...
if __name__ == '__main__':
    ...
    experiments = dict(
        cartpole_swingup=[
            'logs/cartpole-swingup/sac_lsf_rad_ablation_1000init_1gs_aclr1e-4_clr1e-4_allr1e-4_elr1e-4_ac_freq2_2_enccri_tau0.05_0.01_declr1e-4_bs128_baseline_extra_upd_critic_uselsf_1_extraupd_1_n_invupd_1_aug_0_alpha0.5_ar2/',
            'logs/cartpole-swingup/sac_lsf_rad_ablation_1000init_1gs_aclr1e-4_clr1e-4_allr1e-4_elr1e-4_ac_freq2_2_enccri_tau0.05_0.01_declr1e-4_bs128_baseline_extra_upd_critic_uselsf_1_extraupd_1_n_invupd_1_aug_0_alpha0.5_ar4/',
            ...
            's18_logs/cartpole-swingup/sac_lsf_rad_ablation_1000init_1gs_aclr1e-4_clr1e-4_allr1e-4_elr1e-4_ac_freq2_2_enccri_tau0.05_0.01_declr1e-4_bs128_baseline_extra_upd_critic_uselsf_0_extraupd_1_n_invupd_1_aug_0_alpha0.5_ar2/',
            's18_logs/cartpole-swingup/sac_lsf_rad_ablation_1000init_1gs_aclr1e-4_clr1e-4_allr1e-4_elr1e-4_ac_freq2_2_enccri_tau0.05_0.01_declr1e-4_bs128_baseline_extra_upd_critic_uselsf_0_extraupd_1_n_invupd_1_aug_0_alpha0.5_ar4/',
        ...
        cheetah_run=[
            'logs/cheetah-run/sac_lsf_rad_ablation_1000init_1gs_aclr1e-3_clr1e-3_allr1e-4_elr1e-3_ac_freq2_2_enccri_tau0.05_0.01_declr1e-3_bs128_baseline_extra_upd_critic_uselsf_1_extraupd_1_n_invupd_1_aug_0_ar2/',
            ...
            'logs/cheetah-run/sac_lsf_rad_ablation_1000init_1gs_aclr1e-3_clr1e-3_allr1e-4_elr1e-3_ac_freq2_2_enccri_tau0.05_0.01_declr1e-3_bs128_baseline_extra_upd_critic_uselsf_1_extraupd_1_n_invupd_1_aug_0_ar8/',
